...
print(f"Курс:{course_name},  Всего задач: {number_of_completed_homework_assignments},  Затрачено часов: {number_of_hours_spent},  Среднее время выполнения одного задания:{time_for_one_task} минут")